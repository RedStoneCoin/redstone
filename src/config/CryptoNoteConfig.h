...
namespace CryptoNote
{
    namespace parameters
    {
        ...
        const uint64_t MAXIMUM_MIXIN_V1                        =                                 100000;

        const uint64_t MINIMUM_MIXIN_V2                        =                                      0;
        const uint64_t MAXIMUM_MIXIN_V2                        =                                 100000;

        const uint64_t MINIMUM_MIXIN_V3                        =                                      0;
        const uint64_t MAXIMUM_MIXIN_V3                        =                                 100000;
        ...
        const uint64_t DEFAULT_MIXIN_V0                        =                                 100000;
        const uint64_t DEFAULT_MIXIN_V1                        =                                 100000;
        const uint64_t DEFAULT_MIXIN_V2                        =                                 100000;
        const uint64_t DEFAULT_MIXIN_V3                        =                                 100000;
